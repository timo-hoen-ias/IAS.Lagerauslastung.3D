  ...
  lagerorte: [
    {
      ...
      dims: { d1: 1, d2: 1, d3: 1 },
      plaetze: [
        { platzId: 101, dim: { d1: 1, d2: 1, d3: 1 }, ebene: 0, kurz: 'A-01', platzbezeichnung: '', masse: { hoehe: 1, breite: 1, laenge: 1 }, maxGewicht: 0, bestaende: [{ artikelnummer: 'ART-1', bezeichnung1: '', matchcode: '', bestand: 5, verfuegbarkeit: 5, gewicht: 0, einheit: '' }] },
